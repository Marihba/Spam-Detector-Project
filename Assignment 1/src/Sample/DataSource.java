...
public class DataSource {
    public static ObservableList<StudentRecord> getAllStudents() {
        ...
        marks.add(new StudentRecord("100569671", 90.0f, 94.5f, 93.5f));
        marks.add(new StudentRecord("100568672", 93.5f, 86.9f, 98.6f));
        marks.add(new StudentRecord("100100100", 68.5f, 68.4f, 71.5f));
